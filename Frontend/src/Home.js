...
function Home() {
  ...
  <div className="banner">
		<div className="container">
			{/* <h3>Dairy Delight, <span>Special Offers</span></h3> */}
		</div>
	</div>
									...
									productList.map((product)=>(
										...
										<div className="col-md-4 agile_ecommerce_tab_left">
											<div className="hs-wrapper">
												<img src={"../assets/images/"+product.img} alt=" " className="img-responsive" />
												<img src={"../assets/images/"+product.img} alt=" " className="img-responsive" />
												
												<div className="w3_hs_bottom">
													<ul>
														<li>
															<a href={"/product/"+product.id} data-toggle="modal" data-target="#myModal">
											...
											<h5><a onClick={()=>addCartApi(product)} href="javascript:void(0)">Add to Cart</a></h5>
